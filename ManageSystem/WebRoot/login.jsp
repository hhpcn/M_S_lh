...
<html>
	<head>
     ...
     <script type="text/javascript" src="common/security.js"></script>
						...
						<div class="login-container">
							<div class="center">
								...
								<!-- 	<span class="red">后台</span> -->
									<span class="white" id="id-text2">网站管理系统</span>
								</h1>
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form id="loginform" method="post" action="personnel/userAction_login.action" >
												<fieldset>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input id="password" name="password" type="password" class="form-control" placeholder="Password" id="Password"/>
		...
		<script type="text/javascript">
			jQuery(function($) {
			  ...
			  $("#login").click(function(){
				...
				$.ajax({
						url:"/ManageSystem/personnel/userAction_keyPair.action",
						type:"post",
						dataType:"json",
						success:function(data){
						var keydata=data.publicKeyMap;
						var modulus = keydata.modulus, exponent = keydata.exponent;
	    		...
	    		function() {
	    			//.validate({。。。})是初始化验证表单，.valid()是进行验证
		    		  if($("#registerForm").valid()){
		    		      ...
		    		      $.ajax({
								type : "POST",
								url : "/ManageSystem/personnel/userAction_register.action",
