var scripts = [null,"/ManageSystem/common/ace/dist/js/jqGrid/jquery.jqGrid.min.js",
	...
	jQuery(function($) {
		...
		jQuery(grid_selector).jqGrid({
			...
			url:'/ManageSystem/productmanage/kindAction_listKinds.action', //这是Action的请求地址 
			mtype: 'POST', 
			datatype: "json",
			height: 370,
			...
			editurl: "/ManageSystem/productmanage/kindAction_edit.action",//nothing is saved
			caption: "产品分类表格"
...
/**********************更新产品分类开始*****************************************************/
		...
		function loadEditData(){
			//ajax，根据id到取得记录
			$.ajax({
        		url:"/ManageSystem/productmanage/kindAction_loadKindById.action",
        		type:"post",
        		dataType:"json",
        		data:{
        			"id":editIdsArr[0]
		...
		$("#editKind").on("click",function(){
			...
			$.ajax({
        		url:"/ManageSystem/productmanage/kindAction_updateKind.action",
        		type:"post",
        		dataType:"json",
        		data:{
        				"kind.id":id,
...
/**********************增加记录开始*******************************************************/
		...
		$("#addKind").on("click",function(){
			...
			$.ajax({
        		url:"/ManageSystem/productmanage/kindAction_addKind.action",
        		type:"post",
        		dataType:"json",
        		data:{
        				"kind.kindName":kindName,
...
/*******************增加记录结束***********************************************************/
		...
		$('#addkindform').bootstrapValidator({
